...
<head>
    ...
    <title>Home | Charlotte Events</title>
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">CHARLOTTE EVENTS</a>
                </div>
    ...
    <section class="container">
        ...
        <div class="center">
            ...
            ?>" method="post" style="border:1px solid #ccc">
                ...
                <label><b>UNCC ID</b></label>
                    <input type="email" placeholder="Enter UNCC Email ID" name="email" required><br>
